...
const ActiveChatHeader = () => {
    ...
    const activeUserName = activeDialogId && dialogs.find( dialog => dialog._id === activeDialogId).user.fullName
    const status = false;
        ...
        <section className='chat__active-dialog__header'>
            { activeDialogId && (
                <div className='chat__active-dialog__header__user-info'>
                    ...
                    <div>
                        <strong className='chat__active-dialog__header__user-name'>{activeUserName}</strong>
